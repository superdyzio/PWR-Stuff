...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/perdziu/catkin_ws/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/perdziu/catkin_ws/src/robot_localization/devel)
...
if(NOT "/home/perdziu/catkin_ws/src/robot_localization/devel/include;/home/perdziu/catkin_ws/src/robot_localization/include;/usr/include/eigen3" STREQUAL "")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/perdziu/catkin_ws/src/robot_localization/devel/include;/home/perdziu/catkin_ws/src/robot_localization/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tom Moore <tmoore@cra.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/perdziu/catkin_ws/src/robot_localization/${idir}'.  Ask the maintainer 'Tom Moore <tmoore@cra.com>' to fix it.")
    endif()
    _list_append_unique(robot_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "filter_base;ekf")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/perdziu/catkin_ws/src/robot_localization/devel/lib;/home/perdziu/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(depends "roscpp;tf2;tf2_ros;message_filters;std_msgs;geometry_msgs;nav_msgs;sensor_msgs;diagnostic_msgs;diagnostic_updater;cmake_modules;message_runtime")

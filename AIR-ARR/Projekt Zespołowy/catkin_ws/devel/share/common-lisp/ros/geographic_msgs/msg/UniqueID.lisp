...
(cl:defmethod cl:initialize-instance :after ((m <UniqueID>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UniqueID)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name geographic_msgs-msg:<UniqueID> is deprecated: use geographic_msgs-msg:UniqueID instead.")))

(cl:ensure-generic-function 'uuid-val :lambda-list '(m))
(cl:defmethod uuid-val ((m <UniqueID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader geographic_msgs-msg:uuid-val is deprecated.  Use geographic_msgs-msg:uuid instead.")
  (uuid m))

...
(cl:defclass <GeographicMapChanges> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (deletes
    :reader deletes
    :initarg :deletes
    :type (cl:vector geographic_msgs-msg:UniqueID)
   :initform (cl:make-array 0 :element-type 'geographic_msgs-msg:UniqueID :initial-element (cl:make-instance 'geographic_msgs-msg:UniqueID))))
)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GeographicMapChanges>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'deletes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'geographic_msgs-msg:UniqueID))

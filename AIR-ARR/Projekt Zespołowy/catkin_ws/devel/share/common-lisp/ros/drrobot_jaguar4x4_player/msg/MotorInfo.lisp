...
(cl:defmethod cl:initialize-instance :after ((m <MotorInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-msg:<MotorInfo> is deprecated: use drrobot_jaguar4x4_player-msg:MotorInfo instead.")))
...
(cl:defmethod encoder_pos-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:encoder_pos-val is deprecated.  Use drrobot_jaguar4x4_player-msg:encoder_pos instead.")
  (encoder_pos m))

(cl:ensure-generic-function 'encoder_vel-val :lambda-list '(m))
(cl:defmethod encoder_vel-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:encoder_vel-val is deprecated.  Use drrobot_jaguar4x4_player-msg:encoder_vel instead.")
  (encoder_vel m))

(cl:ensure-generic-function 'encoder_dir-val :lambda-list '(m))
(cl:defmethod encoder_dir-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:encoder_dir-val is deprecated.  Use drrobot_jaguar4x4_player-msg:encoder_dir instead.")
  (encoder_dir m))

(cl:ensure-generic-function 'motor_current-val :lambda-list '(m))
(cl:defmethod motor_current-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:motor_current-val is deprecated.  Use drrobot_jaguar4x4_player-msg:motor_current instead.")
  (motor_current m))

(cl:ensure-generic-function 'motor_pwm-val :lambda-list '(m))
(cl:defmethod motor_pwm-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:motor_pwm-val is deprecated.  Use drrobot_jaguar4x4_player-msg:motor_pwm instead.")
  (motor_pwm m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorInfo>)))
  ...
  "drrobot_jaguar4x4_player/MotorInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorInfo)))
  "Returns string type for a message object of type 'MotorInfo"
  "drrobot_jaguar4x4_player/MotorInfo")

...
(cl:in-package drrobot_jaguar4x4_player-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-srv:<SetDatum-request> is deprecated: use drrobot_jaguar4x4_player-srv:SetDatum-request instead.")))

(cl:ensure-generic-function 'geo_pose-val :lambda-list '(m))
(cl:defmethod geo_pose-val ((m <SetDatum-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-srv:geo_pose-val is deprecated.  Use drrobot_jaguar4x4_player-srv:geo_pose instead.")
  (geo_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-request>)))
  ...
  "drrobot_jaguar4x4_player/SetDatumRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-request)))
  "Returns string type for a service object of type 'SetDatum-request"
  "drrobot_jaguar4x4_player/SetDatumRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-srv:<SetDatum-response> is deprecated: use drrobot_jaguar4x4_player-srv:SetDatum-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-response>)))
  ...
  "drrobot_jaguar4x4_player/SetDatumResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-response)))
  "Returns string type for a service object of type 'SetDatum-response"
  "drrobot_jaguar4x4_player/SetDatumResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum)))
  ...
  "drrobot_jaguar4x4_player/SetDatum")
...
(cl:defclass <RangeArray> (roslisp-msg-protocol:ros-message)
  ((ranges
    :reader ranges
    :initarg :ranges
    :type (cl:vector drrobot_jaguar4x4_player-msg:Range)
   :initform (cl:make-array 0 :element-type 'drrobot_jaguar4x4_player-msg:Range :initial-element (cl:make-instance 'drrobot_jaguar4x4_player-msg:Range))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RangeArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-msg:<RangeArray> is deprecated: use drrobot_jaguar4x4_player-msg:RangeArray instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:ranges-val is deprecated.  Use drrobot_jaguar4x4_player-msg:ranges instead.")
  (ranges m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RangeArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'ranges)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'drrobot_jaguar4x4_player-msg:Range))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RangeArray>)))
  ...
  "drrobot_jaguar4x4_player/RangeArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RangeArray)))
  "Returns string type for a message object of type 'RangeArray"
  "drrobot_jaguar4x4_player/RangeArray")

...
(cl:defclass <MotorInfoArray> (roslisp-msg-protocol:ros-message)
  ((motorInfos
    :reader motorInfos
    :initarg :motorInfos
    :type (cl:vector drrobot_jaguar4x4_player-msg:MotorInfo)
   :initform (cl:make-array 0 :element-type 'drrobot_jaguar4x4_player-msg:MotorInfo :initial-element (cl:make-instance 'drrobot_jaguar4x4_player-msg:MotorInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MotorInfoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorInfoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-msg:<MotorInfoArray> is deprecated: use drrobot_jaguar4x4_player-msg:MotorInfoArray instead.")))

(cl:ensure-generic-function 'motorInfos-val :lambda-list '(m))
(cl:defmethod motorInfos-val ((m <MotorInfoArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:motorInfos-val is deprecated.  Use drrobot_jaguar4x4_player-msg:motorInfos instead.")
  (motorInfos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorInfoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motorInfos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'drrobot_jaguar4x4_player-msg:MotorInfo))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorInfoArray>)))
  ...
  "drrobot_jaguar4x4_player/MotorInfoArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorInfoArray)))
  "Returns string type for a message object of type 'MotorInfoArray"
  "drrobot_jaguar4x4_player/MotorInfoArray")

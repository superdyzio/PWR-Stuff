...
(cl:defmethod cl:initialize-instance :after ((m <Range>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Range)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drrobot_jaguar4x4_player-msg:<Range> is deprecated: use drrobot_jaguar4x4_player-msg:Range instead.")))
...
(cl:defmethod radiation_type-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:radiation_type-val is deprecated.  Use drrobot_jaguar4x4_player-msg:radiation_type instead.")
  (radiation_type m))

(cl:ensure-generic-function 'field_of_view-val :lambda-list '(m))
(cl:defmethod field_of_view-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:field_of_view-val is deprecated.  Use drrobot_jaguar4x4_player-msg:field_of_view instead.")
  (field_of_view m))

(cl:ensure-generic-function 'min_range-val :lambda-list '(m))
(cl:defmethod min_range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:min_range-val is deprecated.  Use drrobot_jaguar4x4_player-msg:min_range instead.")
  (min_range m))

(cl:ensure-generic-function 'max_range-val :lambda-list '(m))
(cl:defmethod max_range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:max_range-val is deprecated.  Use drrobot_jaguar4x4_player-msg:max_range instead.")
  (max_range m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drrobot_jaguar4x4_player-msg:range-val is deprecated.  Use drrobot_jaguar4x4_player-msg:range instead.")
  (range m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Range>)))
  ...
  "drrobot_jaguar4x4_player/Range")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Range)))
  "Returns string type for a message object of type 'Range"
  "drrobot_jaguar4x4_player/Range")

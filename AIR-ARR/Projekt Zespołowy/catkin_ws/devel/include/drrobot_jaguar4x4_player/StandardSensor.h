// Generated by gencpp from file drrobot_jaguar4x4_player/StandardSensor.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drrobot_jaguar4x4_player::StandardSensor_<ContainerAllocator> const>
  : TrueType
  { };

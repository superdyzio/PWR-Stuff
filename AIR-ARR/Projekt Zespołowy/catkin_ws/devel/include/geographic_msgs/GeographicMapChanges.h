...
struct GeographicMapChanges_
{
  ...
  _diffs_type diffs;
   ...
   typedef std::vector< ::geographic_msgs::UniqueID_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geographic_msgs::UniqueID_<ContainerAllocator> >::other >  _deletes_type;
...
UniqueID[] deletes  		# deleted map components\n\
\n\
================================================================================\n\
MSG: std_msgs/Header\n\
...
struct Printer< ::geographic_msgs::GeographicMapChanges_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::geographic_msgs::GeographicMapChanges_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.deletes.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "    ", v.deletes[i]);
    }
  }
};

...
struct RoutePath_
{
  ...
  _network_type network;
   ...
   typedef std::vector< ::geographic_msgs::UniqueID_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geographic_msgs::UniqueID_<ContainerAllocator> >::other >  _segments_type;
...
struct Printer< ::geographic_msgs::RoutePath_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::geographic_msgs::RoutePath_<ContainerAllocator>& v)
  {
    ...
    s << indent << "network: ";
    s << std::endl;
    Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "  ", v.network);
    ...
    for (size_t i = 0; i < v.segments.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "    ", v.segments[i]);
    }

...
struct RouteSegment_
{
  ...
  _start_type start;
   ...
   typedef  ::geographic_msgs::UniqueID_<ContainerAllocator>  _end_type;
  _end_type end;
...
struct Printer< ::geographic_msgs::RouteSegment_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::geographic_msgs::RouteSegment_<ContainerAllocator>& v)
  {
    ...
    s << indent << "start: ";
    s << std::endl;
    Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "  ", v.start);
    s << indent << "end: ";
    s << std::endl;
    Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "  ", v.end);

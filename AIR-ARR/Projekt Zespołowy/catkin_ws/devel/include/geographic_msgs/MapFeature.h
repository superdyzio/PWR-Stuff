...
struct MapFeature_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::geographic_msgs::UniqueID_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geographic_msgs::UniqueID_<ContainerAllocator> >::other >  _components_type;
...
struct Printer< ::geographic_msgs::MapFeature_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::geographic_msgs::MapFeature_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.components.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::geographic_msgs::UniqueID_<ContainerAllocator> >::stream(s, indent + "    ", v.components[i]);
    }

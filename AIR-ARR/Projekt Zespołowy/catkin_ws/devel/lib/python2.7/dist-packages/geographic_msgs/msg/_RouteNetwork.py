...
UniqueID id    		 # This route network identifier
...
UniqueID id           		# Unique identifier for this segment

UniqueID start        		# beginning way point of segment
UniqueID end          		# ending way point of segment

KeyValue[] props                # segment properties

"""
  __slots__ = ['header','id','bounds','points','segments','props']
  _slot_types = ['std_msgs/Header','geographic_msgs/UniqueID','geographic_msgs/BoundingBox','geographic_msgs/WayPoint[]','geographic_msgs/RouteSegment[]','geographic_msgs/KeyValue[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.id is None:
        self.id = geographic_msgs.msg.UniqueID()

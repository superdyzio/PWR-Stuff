...
"""
  ...
  _slot_types = ['geographic_msgs/UniqueID','geographic_msgs/UniqueID','geographic_msgs/UniqueID','geographic_msgs/KeyValue[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.start is None:
        self.start = geographic_msgs.msg.UniqueID()
      if self.end is None:
        self.end = geographic_msgs.msg.UniqueID()

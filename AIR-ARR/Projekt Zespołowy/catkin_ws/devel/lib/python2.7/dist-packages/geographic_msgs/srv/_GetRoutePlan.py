...
"""
  ...
  _slot_types = ['geographic_msgs/UniqueID','geographic_msgs/UniqueID','geographic_msgs/UniqueID']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.network is None:
        self.network = geographic_msgs.msg.UniqueID()
      if self.start is None:
        self.start = geographic_msgs.msg.UniqueID()
      if self.goal is None:
        self.goal = geographic_msgs.msg.UniqueID()
    else:
      self.network = geographic_msgs.msg.UniqueID()
      self.start = geographic_msgs.msg.UniqueID()
      self.goal = geographic_msgs.msg.UniqueID()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = geographic_msgs.msg.UniqueID()
        start = end
        end += 16

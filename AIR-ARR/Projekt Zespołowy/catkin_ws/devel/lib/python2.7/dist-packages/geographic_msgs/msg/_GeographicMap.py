...
"""
  ...
  _slot_types = ['std_msgs/Header','geographic_msgs/UniqueID','geographic_msgs/BoundingBox','geographic_msgs/WayPoint[]','geographic_msgs/MapFeature[]','geographic_msgs/KeyValue[]']

/*
$HeadURL: svn+ssh://dperdek@panamint.ict.pwr.wroc.pl/home/dperdek/repos/z2/trunk/inc/menu.hh $
$Author: dperdek $
 ...
 * \brief Konsturktor.
 */
	Menu() { 	_lista.dodaj("command4turn.so"); 	_lista.dodaj("command4rotate.so"); 
			_lista.dodaj("command4move.so"); 	_lista.dodaj("grasper.so"); 		};
/*!
...
/*!
 * \brief Metoda znajdująca bibliotekę w mapie i zwracającą wskaźnik 
 * 					do jej obiektu.
 *

/*
$HeadURL: svn+ssh://dperdek@panamint.ict.pwr.wroc.pl/home/dperdek/repos/z2/trunk/inc/Biblioteka.hh $
$Author: dperdek $
 ...
 * \param[in]	Strm_CmdsList - referencja do strumienia wejściowego z którego 
 *																czytane mają być komendy
 ...
 *
 * Pole te przechowuje wskaźnik typu bazowego (Command) na konkretną, 
 *	dostarczaną przez bibliotekę komendę.
*/
	Command *(*_pCreateCmd)(void);
/*!
 * \brief Pole przechowujące nazwę komendy.
 *
 * Wartości tego pola nie można zmieniać. Mówi ono o nazwie dostarczanego
 * przez bibliotekę polecenia.
 */
	const char* CmdName;
/*!
 * \brief Pole przechowujące wskaźnik typu bazowego na obiekt komendy 
 * 			dostarczanej przez biblioteke.
 */
	Command *_pCmd ;
};

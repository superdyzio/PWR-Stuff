...
namespace PzG {
   ...
   */
  enum RodzajRysowania { RR_Ciagly /*! Linia ma byæ rysowana jako 
                                       sekwencja punktów */, 
                         RR_Punktowy /*! Linia ma byæ rysowana ci±g³± kresk± */
                       }; 
...
class LaczeDoGNUPlota {
 ...
 public:
  ...
  void WyswietlajKomunikatyBledow( bool Tryb = true );
    ...
    * \param  RodzRys - okre¶la sposób rysowania linii. Dostêpne s±
    *                   dwa rodzaje, a mianowicie: ci±g³y i punktowy.
    * \param  Szerokosc - okre¶la szeroko¶æ rysowanej linii. Jest ona
    *                     podana w pikselach.
    *

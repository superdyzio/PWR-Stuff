/*
$HeadURL: svn+ssh://dperdek@panamint.ict.pwr.wroc.pl/home/dperdek/repos/z2/trunk/plugin/inc/command4rotate.hh $
$Author: dperdek $
...
/*!
 * \brief Klasa modeluje polecenie dla robota mobilnego, które wymusza 
 *				jego obrót wokół własnej osi.
 *
 * Klasa jest typem komendy, dziedziczy klasę Command.
 */
class Command4Rotate : public Command {
/*
 * Pole typu double przechowujące informację o szybkości ruchu podanej 
 * w stopniach/s.
 */
  	double _Speed_oS;
/*

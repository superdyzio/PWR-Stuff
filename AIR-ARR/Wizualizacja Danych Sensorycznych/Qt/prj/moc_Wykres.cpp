/****************************************************************************
** Meta object code from reading C++ file 'Wykres.hpp'
**
...
#include "inc/Wykres.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Wykres.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Wykres_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 53, 12)
    ...
    "Wykres\0plotujSymulacje\0\0DaneSymulacji&\0"
    "daneSymulacji\0plotujOdczyt\0"
};
...
void Wykres::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->plotujSymulacje((*reinterpret_cast< DaneSymulacji(*)>(_a[1]))); break;
        case 1: _t->plotujOdczyt(); break;
        default: ;
        }
    }
}
...
const QMetaObject Wykres::staticMetaObject = {
    { &QCustomPlot::staticMetaObject, qt_meta_stringdata_Wykres.data,
      qt_meta_data_Wykres,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Wykres.stringdata))
